...
$mapel = $conn->query("SELECT * FROM mata_pelajaran WHERE id = '$id'");
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="process.php" method="POST" class="form-container">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="kode" class="form-label required-field">Kode Mapel</label>
                            <input type="text" class="form-control" id="kode" name="kode"
                                value="<?= htmlspecialchars($mapel['kode_mapel']); ?>" required>
                        </div>

                        <div class="col-12">
                            <label for="nama" class="form-label required-field">Nama Mata Pelajaran</label>
